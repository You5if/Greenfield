...
export class FinancialComponent implements OnInit {
  ...
  afterThat(){
    ...
    if(localStorage.getItem(this._globals.baseAppName + '_language') == "16001") {
      var src = [
        {report: "Account summary", account: 148 , value2:this.acc, fromDate: Tdate, toDate: Tdate, companyAppear: false, accountAppear: true},
        {report: "Account summary (company-wise)", company: 2, value: copm, account: 148 ,  value2:this.acc, fromDate: Tdate , toDate: Tdate, companyAppear: true, accountAppear: true},
        {report: "Trial balance", fromDate: Tdate, toDate: Tdate, companyAppear: false, accountAppear: false },
        {report: "Trial balance(company)", company: 2, value: copm, fromDate: Tdate, toDate: Tdate, companyAppear: true, accountAppear: false },
        
        
      ]
    }else if(localStorage.getItem(this._globals.baseAppName + '_language') == "16002") {
      var src = [
        {report: "ملخص الحساب", account: 148 , value2:this.acc, fromDate: Tdate, toDate: Tdate, companyAppear: false, accountAppear: true},
        {report: "ملخص الحسابات (الشركة)", company: 2, value: copm, account: 148 ,  value2:this.acc, fromDate: Tdate , toDate: Tdate, companyAppear: true, accountAppear: true},
        {report: "ميزان المراجعة", fromDate: Tdate, toDate: Tdate, companyAppear: false, accountAppear: false },
        {report: "ميزان المراجعة (الشركة)", company: 2, value: copm, fromDate: Tdate, toDate: Tdate, companyAppear: true, accountAppear: false },
  ...
  onReport(report: string,fromDate: Date, toDate:Date, company: number, account: number) { 
    var reportId: number
