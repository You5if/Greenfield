...
export class AppGlobals {
  ...
  /* Development Server */
  readonly baseAPIFileUrl: string = "http://greenfieldapi.autopay-mcs.com/";
  readonly baseAPIUrl: string = "http://greenfieldapi.autopay-mcs.com/api/";
  readonly baseAPIRootUrl: string = "http://greenfieldapi.autopay-mcs.com/api/";
